...
IDEAEventAction::IDEAEventAction()
 : G4UserEventAction(),
   fAbsHCID(-1),
   fGapHCID(-1)
{}
...
IDEAPreShowerHitsCollection* 
IDEAEventAction::GetHitsCollection(G4int hcID,
                                  const G4Event* event) const
{
  auto hitsCollection 
    = static_cast<IDEAPreShowerHitsCollection*>(
        event->GetHCofThisEvent()->GetHC(hcID));
  
  if ( ! hitsCollection ) {
    G4ExceptionDescription msg;
    msg << "Cannot access hitsCollection ID " << hcID; 
    G4Exception("IDEAEventAction::GetHitsCollection()",
...
void IDEAEventAction::PrintEventStatistics(
...
void IDEAEventAction::BeginOfEventAction(const G4Event* /*event*/)
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void IDEAEventAction::EndOfEventAction(const G4Event* event)
{  
